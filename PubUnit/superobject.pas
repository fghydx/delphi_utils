...
{$ENDIF}
    ...
    /// <param name="indent">是否格式化，方便阅读 </param>
    /// <param name="escape">保存为UniCode还是Ansic，True:ansic,False:UniCode </param>
...
//          goto out;
    ...
    inc(str);
    inc(tok.char_offset);
//    if (str^=#0) and (TokRec^.saved_state <> tsFinish) then
//    begin
//      Dec(str,tok.depth+1);
//      str^:='"';
//      v := str^;
