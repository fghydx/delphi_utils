...
function URLEncode_GB2312(const S: AnsiString; const InQueryString: Boolean=false): AnsiString;
...
function DelRight(str: string; start: string; Index: Integer): string;overload;
//删除右边开始多少个字符
function DelRight(str:string;count:integer):string;overload;
...
begin
  ...
  begin
    ...
    begin
      Result := IntToStr(Data)+Tmpstr[I] + Result;
      Break;
    end;
...
function DelRight(str:string;count:integer):string;
begin
  Result := LeftStr(str,Length(str)-count);
end;
