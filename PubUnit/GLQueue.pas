...
type
  ...
  public
    ...
    function CheckPop(Out P:Pointer;ASetCanPop:Boolean;out ATag: Int64):Boolean;            //这个函数用于IOCP中的弹出,其它地方看个人是否有这种需要
...
function TGLQueue.CheckPop(Out P: Pointer;ASetCanPop:Boolean;out ATag: Int64): Boolean;
var
  Tmp: TCnNode;
begin
  if FBlocked then
