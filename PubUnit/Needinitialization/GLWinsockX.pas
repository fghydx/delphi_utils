...
type
  ...
  function LoadDisconnectEx(const s : TSocket) : boolean;
...
var
  ...
  {$ENDIF}
  DisconnectEx_P:^LPFN_DISCONNECTEX=nil;
...
begin
  if DisconnectEx_P=nil then
  begin
    DisconnectEx_P := FixupStubEx(s, 'DisconnectEx', WSAID_DISCONNECTEX); {Do not localize}
  end;
  @DisconnectEx := DisconnectEx_P;  
