...
Type
  ...
  public
    ...
    function GetObject(Key:Cardinal):TObject;
...
function TGLIntHashTable.AddObject(Key: Cardinal; Value: TObject): Boolean;
begin
  Result := Add(Key,Value,0);
end;
...
function TGLIntHashTable.GetObject(Key: Cardinal): TObject;
var
  DataLen:Cardinal;
begin
  result := Find(Key,DataLen);
